...
import os.com.krishirasayan.adapters.ProductRetailerBuyAdapter;
...
public class RetailerProductListActivity extends AppCompatActivity {
                ...
                .withCallbacks(new IVolleyResult() {
                    ...
                    public void notifySuccess(String requestName, JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            productModel.setPrice(productObject.optString("min_price_retailer"));
                            ...
                            for(int j = 0; j < productObject.optJSONArray("product_variants").length(); j++) {
                                ...
                                productVariantModel.setListingPrice(productVariantObject.optString("retailer_listing_price"));
                                productVariantModel.setSellingPrice(productVariantObject.optString("retailer_selling_price"));
    ...
    private void setProductListRecycler(List<ProductModel> productList) {
        ...
        rcvAllProductList.setAdapter(new ProductRetailerBuyAdapter(context, productList));
