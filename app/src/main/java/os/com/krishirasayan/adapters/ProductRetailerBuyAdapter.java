...
public class ProductRetailerBuyAdapter extends RecyclerView.Adapter<ProductRetailerBuyAdapter.ProductViewHolder> {
    ...
    public ProductRetailerBuyAdapter(Context context, List<ProductModel> allProductList) {
        this.context = context;
        this.allProductList = allProductList;
    }

    public ProductRetailerBuyAdapter(Context context, List<ProductModel> allProductList, boolean selectable) {
        this.context = context;
        this.allProductList = allProductList;
        this.selectable = selectable;
    }

    public ProductRetailerBuyAdapter(Context context, List<ProductModel> allProductList, boolean selectable, ICallback iCallback) {
        this.context = context;
        this.allProductList = allProductList;
        this.selectable = selectable;
