...
public class OrderDetailsAdapter extends RecyclerView.Adapter<OrderDetailsAdapter.OrderViewHolder> {
    ...
    public OrderDetailsAdapter(Context context, List<OrderModel> allOrderList) {
        this.context = context;
        this.allOrderList = allOrderList;
    }

    public OrderDetailsAdapter(Context context, List<OrderModel> allOrderList, boolean selectable) {
        this.context = context;
        this.allOrderList = allOrderList;
        this.selectable = selectable;
    }

    public OrderDetailsAdapter(Context context, List<OrderModel> allNewsList, boolean selectable, ICallback iCallback) {
        this.context = context;
        this.allOrderList = allOrderList;
        this.selectable = selectable;
    ...
    public static final class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView ivOrderitemProductTitle,ivOrderitemProductPoint, ivOrderitemProductPrice, tvOrderItemQtyValue, tvOrderItemVarValue;
