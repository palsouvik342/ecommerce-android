...
public class GiftAdapter extends RecyclerView.Adapter<GiftAdapter.GiftViewHolder> {
    ...
    public GiftAdapter(Context context, List<GiftModel> allGiftList) {
        this.context = context;
        this.allGiftList = allGiftList;
    }

    public GiftAdapter(Context context, List<GiftModel> allGiftList, boolean selectable) {
        this.context = context;
        this.allGiftList = allGiftList;
        this.selectable = selectable;
    }

    public GiftAdapter(Context context, List<GiftModel> allGiftList, boolean selectable, ICallback iCallback) {
        this.context = context;
        this.allGiftList = allGiftList;
        this.selectable = selectable;
