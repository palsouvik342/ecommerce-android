...
public class CartInvoiceListAdapter extends RecyclerView.Adapter<CartInvoiceListAdapter.ProductViewHolder> {
    ...
    public CartInvoiceListAdapter(Context context, List<ProductModel> allProductList) {
        this.context = context;
        this.allProductList = allProductList;
    }

    public CartInvoiceListAdapter(Context context, List<ProductModel> allProductList, boolean selectable) {
        this.context = context;
        this.allProductList = allProductList;
        this.selectable = selectable;
    }

    public CartInvoiceListAdapter(Context context, List<ProductModel> allProductList, boolean selectable, ICallback iCallback) {
        this.context = context;
        this.allProductList = allProductList;
        this.selectable = selectable;
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
       ...
       if(!listProduct.getProductVariant().isEmpty()) {
        ...
        if(!listProduct.getPrice().isEmpty()) {
            holder.tvCartProductPoint.setText("Pt. " + listProduct.getPoint());
        }
        if(!listProduct.getImageUrl().isEmpty()) {
            Picasso.get().load(listProduct.getImageUrl()).into(holder.ivCartProductImage);
        }

        holder.tvProductListCartQtyValue.setEnabled(true);
