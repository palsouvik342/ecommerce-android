...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.AddressViewHolder> {
    ...
    public NewsAdapter(Context context, List<NewsModel> allNewsList) {
        this.context = context;
        this.allNewsList = allNewsList;
    }

    public NewsAdapter(Context context, List<NewsModel> allNewsList, boolean selectable) {
        this.context = context;
        this.allNewsList = allNewsList;
        this.selectable = selectable;
    }

    public NewsAdapter(Context context, List<NewsModel> allNewsList, boolean selectable, ICallback iCallback) {
        this.context = context;
        this.allNewsList = allNewsList;
        this.selectable = selectable;
    ...
    public void onBindViewHolder(@NonNull AddressViewHolder holder, int position) {
        ...
        /* // addres pill data
        holder.tvContact.setText(listNews.getContactName());
        holder.tvAddress.setText(listNews.getLine1());
        holder.tvLocation.setText(listNews.getLocation()); */

         //news list pill data
        holder.tvBlogListTitle.setText(listNews.getTitle());
        Picasso.get()
                .load(listNews.getImageUrl())
                .error(R.drawable.blog_feature_list_image)
                .placeholder(R.drawable.blog_feature_list_image)
                .into(holder.ivBlogListImage);

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*Toast.makeText(context, listNews.getId(), Toast.LENGTH_SHORT).show();*/
