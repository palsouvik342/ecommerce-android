...
public class GiftRedeemModel {
    ...
    public void setGiftList(ArrayList<GiftModel> giftList) {
    ...
    public GiftRedeemModel(Context context) {
    ...
    public boolean equals(Object object) {
        return this.id.equals(((GiftRedeemModel) object).id);
    }
